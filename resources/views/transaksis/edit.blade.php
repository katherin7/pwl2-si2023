                    ...
                    <div class="card-body">
                        <form id="editForm" action="{{ route('transaksis.update',$transaksis['transaksi']->id) }}" method="POST" enctype ="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('email_pembeli') is-invalid @enderror" name="email_pembeli" value="{{ old('email_pembeli', $transaksi->email_pembeli) }}" required>
                                @error('email_pembeli')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
